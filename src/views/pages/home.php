...
<section style="height: 80vh; background: url('/assets/img/hero-nanook-2.jpg') center/cover no-repeat; display:flex; align-items:center; justify-content:center; margin-bottom:60px;">
    <div style="text-align:center; color:#FFF; height: 100%; display: flex; flex-direction: column">
        ...
        <div style="font-size: 1.2rem; text-shadow: -2px -2px 2px rgba(255,255,255,.1), 2px 2px 2px rgba(0,0,0,.5);text-transform: uppercase">hiver 2026</div>
            ...
            <a href="/p/<?= htmlspecialchars($p['slug']) ?>" class="nk-product-card <?= $gridClass ?>">
                ...
                <div class="nk-product-info">
                    ...
                    <?php if (!empty($p['category_names'])): ?>
                        <div style="font-size:0.7rem; color:#999;letter-spacing:1px; margin-bottom:4px;">
