        ...
        function renderCategories() {
            ...
            for (let cat of categoriesCache) {
                ...
                if (parseInt(cat.is_active) === 1) {
                    ...
                    statusBadge.title = 'Cliquez pour désactiver';
                    statusBadge.onclick = () => toggleCategoryStatus(cat.id, 0);
                } else {
                    statusBadge.className = 'badge badge-red';
                    statusBadge.textContent = 'Inactif';
                    statusBadge.title = 'Cliquez pour activer';
                    statusBadge.onclick = () => toggleCategoryStatus(cat.id, 1);
                }
